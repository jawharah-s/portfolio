...
Apply correct data types and primary keys
Insert and manage records
Run queries to retrieve table data and metadata

All work was completed in Microsoft SQL Server as part of my database coursework.
